...
const FileCard: FC<{ file: any }> = ({ file }) => (
	<a
		href={file.file_url}
		target="_blank"
...
const TaskResultDisplay: FC<{ result: any }> = ({ result }) => {
...
const SwarmPlanSection: FC<{ plan: any[] }> = ({ plan }) => {
...
const CurrentPlanSection: FC<{ task: Task }> = ({ task }) => {
