...
import { startOfDay, addDays, parseISO, isAfter, isSameDay, getDay } from "date-fns"
/**
 ...
 */
export function calculateNextRun(schedule: any, createdAt: string, runs: any[]): Date | null {
	if (
		!schedule ||
