...
const OnboardingPage: FC = () => {
	...
	const [score, setScore] = useState(0) // This seems unused, but I'll keep it for now.
	...
	const submitOnboardingMutation = useMutation({
		mutationFn: (onboardingData: Record<string, any>) =>
		...
		onSuccess: async (data, submittedAnswers: Record<string, any>) => {
			posthog?.identify(
